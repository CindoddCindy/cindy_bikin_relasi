...
@Singleton
public class AnggotaRepository implements AnggotaInterface {

    @PersistenceContext
    private EntityManager manager;

    public AnggotaRepository(@CurrentSession EntityManager manager){
    ...
    try {
        Anggota insert = manager.find(Anggota.class, id); // diganti 
        if(insert != null){
